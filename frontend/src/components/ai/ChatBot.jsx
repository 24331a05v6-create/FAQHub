    ...
    <>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            {/* Header */}
            <div className="p-4 gradient-primary text-white shrink-0 relative overflow-hidden">
            ...
            <div className="p-3 border-t border-gray-200 dark:border-gray-700/50 bg-white/50 dark:bg-gray-900/50 shrink-0 backdrop-blur">
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => sendMessage(input)} disabled={!input.trim() || loading}
                  className="p-2.5 rounded-xl gradient-primary text-white disabled:opacity-40 disabled:cursor-not-allowed transition-all shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40">
